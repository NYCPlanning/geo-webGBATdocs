<h2 style="font-size:x-large; font-weight:bold;"> GOAT User Guide </h2>
...
and block, police precinct, community district and City Council district.

<span class="labels-header"><a name="menu"></a><b>General Instructions:</b></span>
...
or a tax lot, and returns a set of related geographic data.
...
Codes (GRCs) and Reason Codes can be found <a href="/grc_list.pdf" target="\_blank">here</a>.
...
Remember to change the borough if necessary.
...
<b><i>Tips for Efficient Data Entry of Street Names</i></b>

To minimize typing when entering street names, take advantage of the following features
available with all GOAT functions:
...
search through an alphabetical list of all the names that GOAT recognizes as valid.
...
<a href="#menu" class="right-align">Return to Menu</a>
<hr />

<a name="f1b"></a><b>ADDRESS Help:</b>
...
<b>1. Display Street and Property Information (Function 1B)</b>
...
/ Code) Help for more information.

<b><i>Instructions for Entering Function 1B Input Data:</i></b>
...
City Service Information may vary as well.

<b>2. Display Address Point Information (Function AP)</b>
...
<b><i>Instruction for Entering Function AP Input Data:</i></b>
...
<a name="f2"></a><b>INTERSECTION (Function 2) Help:</b>
...
<b><i>Instructions for Entering Function 2 Input Data:</i></b>

The INTERSECTION tab in the GOAT application offers two input options:
<ol>
...
<div class="indent">
  ...
  as one of the input street names and DEAD END as the other input street name.<br><br>
...
a place name as input.

<a href="#menu" class="right-align">Return to Menu</a>
<hr />

<a name="f3"></a><b>STREET SEGMENT (Function 3) Help:</b>
...
<b><i>Instructions for Entering Function 3 Input Data:</i></b>
...
<div class="indent">
  ...
  street names and WATSON AVENUE as the other cross street name.<br><br>
  ...
  street names and X ISLE PARKWAY ENTRANCE NB as the other street name.<br><br>
  ...
  Nassau side of the county border.<br><br>

</div>

Place names may not be used for either On street or Cross Street names in a STREET
SEGMENT (Function 3) call.

<a href="#menu" class="right-align">Return to Menu</a>
<hr />

<a name="f3s"></a><b>STREET STRETCH (Function 3S) Help:</b>
...
message indicating that the compass direction was not required.

<b><i>Instructions for Entering STREET STRETCH (Function 3S) Input Data:</i></b>

All streets supplied must be in the same borough.
...
<div class="indent">
  ...
  stretch may have more than two bending points.<br><br>
  ...
  street may be hard since a street stretch may have multiple dead ends.<br><br>


  Linden Boulevard in Queens intersects with the city limit (in this case, the Queens-Nassau
  County border). To submit a Function 3S inquiry that includes the city boundary,
  enter LINDEN BOULEVARD as the On Street name and CITY LIMIT as one of the cross
  streets and, say, FRANCIS LEWIS BOULEVARD as the other cross street.<br><br>
...
<a name="fbl"></a><b>BLOCK &amp; LOT (Function BL) Help</b>

The input data to BLOCK &amp; LOT (Function BL) is a Borough, Tax Block and Tax
Lot. The information returned is property -specific and building -specific.

In addition to the &#8216;fixed' data returned, you have a choice of receiving a
list of up to twenty one addresses which applies to the property and/or a list of
BINs (Building Identification Numbers) that reside on the property.
...
<b><i>Instructions for Entering BLOCK &amp; LOT (Function BL) Input Data:</i></b>
...
warning message indicating that the lot has more addresses than are displayed.

<a href="#menu" class="right-align">Return to Menu</a>
<hr />

<a name="fbn"></a><b>BIN (Function BN) Help:</b>
...
<b><i>Instructions for Entering Function BN Input Data:</i></b>
...
multiple structures. BINs with this numbering scheme are no longer assigned.

<a href="#menu" class="right-align">Return to Menu</a>
<hr />

<a name="fsc"></a><b>STREET (Name / Code) Help:</b>
...
Code and Geographic Feature Type.

<b><i>General Instructions and Information regarding Street Name / Code:</i></b>
...
Each 10 digit street code is unique to a specific spelling variation of a street.
...
same name. For example, all five boroughs have a street named BROADWAY.
...
of this user guide, but some notable characteristics are as follows:
<ul>
...
spelled out alphabetically (Sixth Avenue) and with the numeric word spelled
out alphabetically (Sixth Avenue).

The following are examples of various types of aliases:
<ul>
...
Street Codes (B7SC&#8217;s), are identical</i>.
...
to the names of the complex&#8217;s other constituent entities.
...
names will &#8216;sort&#8217; logically:

<table class="borderlessTable">

  <tr>
    <td>SORTED LIST IN COMPACT FORMAT</td>
    <td>SORTED LIST IN SORT FORMAT</td>
  <tr>
  ...
  <tr>
    ...
    <td><span class="space_sort">bbb</span>5 AVENUE</td>
  </tr>

  <tr>
    <td>EAST 1 STREET</td>
    <td><span class="space_sort">bb</span>10 AVENUE</td>
  </tr>

  <tr>
    <td>EAST 10 STREET</td>
    <td>EAST <span class="space_sort">bbb</span>1 STREET</td>
  </tr>

  <tr>
    <td>EAST 102 STREET</td>
    <td>EAST <span class="space_sort">bbb</span>2 STREET</td>
  </tr>

  <tr>
    <td>EAST 129 STREET</td>
    <td>EAST <span class="space_sort">bbb</span>3 STREET</td>
  </tr>

  <tr>
    <td>EAST 13 STREET</td>
    <td>EAST <span class="space_sort">bbb</span>9 STREET</td>
  </tr>

  <tr>
    <td>EAST 167 STREET</td>
    <td>EAST <span class="space_sort">bb</span>10 STREET</td>
  </tr>

  <tr>
    <td>EAST 2 STREET</td>
    <td>EAST <span class="space_sort">bb</span>13 STREET</td>
  </tr>

  <tr>
    <td>EAST 20 STREET</td>
    <td>EAST <span class="space_sort">bb</span>20 STREET</td>
  </tr>

  <tr>
    <td>EAST 201 STREET</td>
    <td>EAST <span class="space_sort">bb</span>79 STREET</td>
  </tr>

  <tr>
    <td>EAST 3 STREET</td>
    <td>EAST <span class="space_sort">b</span>102 STREET</td>
  </tr>

  <tr>
    <td>EAST 79 STREET</td>
    <td>EAST <span class="space_sort">b</span>129 STREET</td>
  </tr>

  <tr>
    <td>EAST 9 STREET</td>
    <td>EAST <span class="space_sort">b</span>167 STREET</td>
  </tr>

  <tr>
  <td>FULTON STREET</td>
  <td>EAST <span class="space_sort">b</span>201 STREET</td>
  </tr>
...
in the sort format, it sorts behind those street names.

For more information regarding street names and street codes, please refer to our
<a href="/upg.pdf#page=31" target="\_blank">User Programming Guide (Chapters III and IV)</a>.

<b><i>Instructions for Entering STREET (Name / Code) data:</i></b>

The STREET (Name / Code) tab in the GOAT application offers a variety of options:
<ol>
...
The output will always be in sort format.

<a href="#menu" class="right-align">Return to Menu</a></div>
</li>
</ol>
